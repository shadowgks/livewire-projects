<div>
    <div class="flex gap-6 justify-center items-center p-16">
        ...
        <button wire:click="calculator" class="bg-blue-600 text-white py-2 px-3 rounded-sm disabled:cursor-not-allowed disabled:bg-opacity-90" {{ $disabled ? 'disabled' : '' }}>=</button>
    </div>
